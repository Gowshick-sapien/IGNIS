...
- **Random Seed**: 4321
- **Total Execution Duration**: 1.75 seconds
- **Execution Date (UTC)**: 2026-08-01T09:36:29Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.5335 s (Min: 0.1121 s, Max: 0.9553 s, Med: 0.5323 s, StdDev: 0.2594 s, CI95: [0.348, 0.7191]) | 1.0 | <= | **PASS** | Mean 0.5335 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.5335s, validating the primary value proposition of the edge architecture.
