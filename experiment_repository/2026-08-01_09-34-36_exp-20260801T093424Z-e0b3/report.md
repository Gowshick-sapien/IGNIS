...
- **Random Seed**: 4321
- **Total Execution Duration**: 1.74 seconds
- **Execution Date (UTC)**: 2026-08-01T09:34:27Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.4460 s (Min: 0.0277 s, Max: 0.9590 s, Med: 0.3762 s, StdDev: 0.3235 s, CI95: [0.2145, 0.6774]) | 1.0 | <= | **PASS** | Mean 0.4460 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.4460s, validating the primary value proposition of the edge architecture.
