...
- **Random Seed**: 4321
- **Total Execution Duration**: 4.65 seconds
- **Execution Date (UTC)**: 2026-08-01T04:15:18Z
...
|---|---|---|---|
| **S3** | 5 | **PASS** | All assertions passed across 2 rules |
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.3539 s (Min: 0.1481 s, Max: 0.5572 s, Med: 0.3544 s, StdDev: 0.1622 s, CI95: [0.1525, 0.5553]) | 1.0 | <= | **PASS** | Mean 0.3539 s <= threshold 1.0 s |
...
|---|---|---|---|
| **Fog Decision Latency** (<1.0s target) | S3 | ✅ Validated | All assertions passed |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.3539s, validating the primary value proposition of the edge architecture.
