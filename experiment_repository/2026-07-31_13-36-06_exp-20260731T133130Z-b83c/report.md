...
- **Execution Date (UTC)**: 2026-07-31T13:31:37Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.4223 s (Min: 0.0292 s, Max: 0.9107 s, Med: 0.2402 s, StdDev: 0.4002 s, CI95: [-0.0747, 0.9192]) | 1.0 | <= | **PASS** | Mean 0.4223 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.4223s, validating the primary value proposition of the edge architecture.
