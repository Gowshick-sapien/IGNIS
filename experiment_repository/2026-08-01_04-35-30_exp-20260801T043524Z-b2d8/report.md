...
- **Execution Date (UTC)**: 2026-08-01T04:35:26Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.5949 s (Min: 0.1004 s, Max: 0.9499 s, Med: 0.6416 s, StdDev: 0.3256 s, CI95: [0.1907, 0.9991]) | 1.0 | <= | **PASS** | Mean 0.5949 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.5949s, validating the primary value proposition of the edge architecture.
