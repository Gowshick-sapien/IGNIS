...
- **Random Seed**: 4321
- **Total Execution Duration**: 0.98 seconds
- **Execution Date (UTC)**: 2026-08-01T09:29:03Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.5973 s (Min: 0.1513 s, Max: 0.9974 s, Med: 0.6918 s, StdDev: 0.3596 s, CI95: [0.1508, 1.0438]) | 1.0 | <= | **PASS** | Mean 0.5973 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.5973s, validating the primary value proposition of the edge architecture.
