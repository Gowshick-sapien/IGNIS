...
- **Execution Date (UTC)**: 2026-08-01T09:15:54Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.4939 s (Min: 0.0479 s, Max: 0.8940 s, Med: 0.5884 s, StdDev: 0.3597 s, CI95: [0.0473, 0.9406]) | 1.0 | <= | **PASS** | Mean 0.4939 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.4939s, validating the primary value proposition of the edge architecture.
