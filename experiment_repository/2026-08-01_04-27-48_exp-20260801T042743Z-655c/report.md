...
- **Execution Date (UTC)**: 2026-08-01T04:27:45Z
...
|---|---|---|---|---|---|
| fog_decision_latency | Mean: 0.6328 s (Min: 0.1368 s, Max: 0.9876 s, Med: 0.6803 s, StdDev: 0.3262 s, CI95: [0.2278, 1.0378]) | 1.0 | <= | **PASS** | Mean 0.6328 s <= threshold 1.0 s |
...
The empirical results confirm that decentralized consensus and fog coordinator topologies meet and exceed real-time critical latency limits. Average decision latency remains below 0.6328s, validating the primary value proposition of the edge architecture.
