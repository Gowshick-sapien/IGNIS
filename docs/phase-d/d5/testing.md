...
4. **Observe the Central NOC Dashboard**:
   ...
   - **Zone 4C** should transition to **YELLOW** status with the warning flag showing: `⚠️ WARNING WIND FROM 4B`, even though Zone 4C's own edge sensors report normal GREEN conditions.
